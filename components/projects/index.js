              ...
              <SocialLinks>
                <Link href="https://unitor.netlify.app/">
                  <a style={{ textDecoration: 'none' }} target="_blank">
                    <BiLinkExternal size={25} style={{ color: '#dadada' }} />
                  </a>
                </Link>
                <Link href="https://github.com/surajnarsale/unitor-admin-panel">
                  <a style={{ textDecoration: 'none' }} target="_blank">
                    <AiFillGithub size={25} style={{ color: '#dadada', marginLeft: '1em' }} />
                  </a>
                </Link>
              </SocialLinks>
            </Inner>
        ...
        <Wrapper>
          <Left>
            <Inner>
              ...
              <Stack>
                <StackItem>React Native</StackItem>
              </Stack>
              <Feature>
                Convertino is a currency converter app which can convert currency in real time
              </Feature>
              <SocialLinks>
                <Link href="https://play.google.com/store/apps/details?id=ttpc.covertinoapp">
                  <a style={{ textDecoration: 'none' }} target="_blank">
                    <BiLinkExternal size={25} style={{ color: '#dadada' }} />
                  </a>
                </Link>
                <Link href="https://github.com/surajnarsale/convertino-currency-converter-app">
                  <a style={{ textDecoration: 'none' }} target="_blank">
                    <AiFillGithub size={25} style={{ color: '#dadada', marginLeft: '1em' }} />
                  </a>
                </Link>
          ...
          <a href="https://play.google.com/store/apps/details?id=ttpc.covertinoapp" target="_blank">
            <img src="/convertino.png"></img>
          </a>
        </Wrapper>
        <Wrapper>
          <Left>
            <Inner>
              <Subtitle>
                Choppinz
                <br />
                Ecommerce site with backend connected
              </Subtitle>
              <Stack>
                <StackItem>React</StackItem>
                <StackItem>Graphql</StackItem>
                <StackItem>Typescript</StackItem>
                <StackItem>Urql</StackItem>
                <StackItem>Strapi</StackItem>
              </Stack>
              <Feature>
                Choppinz is a Ecommerce site which sells Vaccum Fried Fruit and Vegetable Chips
              </Feature>
              <SocialLinks>
                <Link href="https://github.com/surajnarsale/chopinz-ecom">
                  <a style={{ textDecoration: 'none' }} target="_blank">
                    <AiFillGithub size={25} style={{ color: '#dadada', marginLeft: '1em' }} />
                  </a>
                </Link>
          ...
          <a href="https://github.com/surajnarsale/chopinz-ecom" target="_blank">
            <img src="/chopinz.png"></img>
          </a>
        </Wrapper>
        <Wrapper>
          <Left>
        ...
        <Wrapper>
          <Left>
            <Inner>
              ...
              <Feature>
                Onip is a public ip tracker that displays loacation of any public IP address on map.
                Also it can show the public ip of the system by which it is accessed.
              </Feature>
              <SocialLinks>
        ...
        <Wrapper>
          <Left>
            <Inner>
              ...
              <Feature>
                Minet is a realtime cryptocurrency price tracker which delivers realtime data with
                GUI.
              </Feature>
              <SocialLinks>
        ...
        <Wrapper>
          <Left>
            <Inner>
              ...
              <Feature>
                Eternals is a vs code dark theme suitable for long hours of coding sessions.
              </Feature>
              <SocialLinks>
